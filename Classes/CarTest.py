...
class CarTest(object):
    def __init__(self, ID, position, defaultVelocity, path=None, colour='black', plotting=False):
        self.ID = ID
        self.colour = colour
    ...
    def draw(self, screen):
        pygame.draw.circle(screen, self.colour, (int(self.position[0]), int(self.position[1])), 5) # last number is radius
